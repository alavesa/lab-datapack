...
execute if score #total lab.var matches 0 run return run title @s actionbar {"text":"The machine is empty.","color":"gray"}
...
execute if score #done lab.var matches 0 run function lab:react/refund
execute if score #done lab.var matches 0 if score #needheat lab.var matches 1 run return run title @s actionbar {"text":"This mixture needs the Gas Burner.","color":"gray"}
