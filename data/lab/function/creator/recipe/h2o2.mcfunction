# Creator grid: 2 H + 2 O -> Hydrogen Peroxide (H2O2). Exact match only.
...
title @a[distance=..6] actionbar {"text":"The mixture becomes Hydrogen Peroxide.","color":"gray"}
