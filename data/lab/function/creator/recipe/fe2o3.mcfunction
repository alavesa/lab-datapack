# Creator grid: 2 Fe + 3 O -> Rust (Fe2O3). Exact match only.
...
summon item ~ ~0.8 ~ {PickupDelay:15,Item:{id:"minecraft:raw_iron",count:1}}
...
title @a[distance=..6] actionbar {"text":"The mixture becomes Rust.","color":"gray"}
