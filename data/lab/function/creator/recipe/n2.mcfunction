# Creator grid: 2 N -> Nitrogen Gas (N2). Exact match only.
execute unless score #done lab.var matches 0 run return 0
execute unless score #c_N lab.var matches 2 run return 0
...
title @a[distance=..6] actionbar {"text":"The mixture becomes Nitrogen Gas.","color":"gray"}
