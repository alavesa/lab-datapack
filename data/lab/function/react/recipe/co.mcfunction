...
summon item ~0.5 ~1.1 ~0.5 {PickupDelay:15,Item:{id:"minecraft:potion",count:1,components:{"minecraft:custom_name":{text:"Carbon Monoxide",color:"aqua",italic:false},"minecraft:lore":[{text:"CO",color:"gray",italic:false},{text:"Lab compound",color:"dark_gray",italic:false}],"minecraft:custom_data":{lab_compound:"CO",lab_is_compound:1b},"minecraft:max_stack_size":1,"minecraft:potion_contents":{custom_color:6710886,custom_effects:[{id:"minecraft:poison",duration:100,amplifier:0}]}}}}
