...
summon item ~0.5 ~1.1 ~0.5 {PickupDelay:15,Item:{id:"minecraft:potion",count:1,components:{"minecraft:custom_name":{text:"Ethanol",color:"aqua",italic:false},"minecraft:lore":[{text:"C2H5OH",color:"gray",italic:false},{text:"Lab compound",color:"dark_gray",italic:false}],"minecraft:custom_data":{lab_compound:"C2H5OH",lab_is_compound:1b},"minecraft:max_stack_size":1,"minecraft:potion_contents":{custom_color:16113331,custom_effects:[{id:"minecraft:nausea",duration:300,amplifier:0}]}}}}
