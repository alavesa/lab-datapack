...
summon item ~0.5 ~1.1 ~0.5 {PickupDelay:15,Item:{id:"minecraft:potion",count:1,components:{"minecraft:custom_name":{text:"Glucose",color:"aqua",italic:false},"minecraft:lore":[{text:"C6H12O6",color:"gray",italic:false},{text:"Lab compound",color:"dark_gray",italic:false}],"minecraft:custom_data":{lab_compound:"C6H12O6",lab_is_compound:1b},"minecraft:max_stack_size":1,"minecraft:potion_contents":{custom_color:16770229,custom_effects:[{id:"minecraft:speed",duration:400,amplifier:0},{id:"minecraft:haste",duration:400,amplifier:0}]}}}}
...
tellraw @a[distance=..8] {"text":"[Lab] 6 C + 12 H + 6 O -> Glucose (C6H12O6)","color":"aqua"}
# experiments
