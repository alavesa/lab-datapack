...
summon item ~0.5 ~1.1 ~0.5 {PickupDelay:15,Item:{id:"minecraft:potion",count:1,components:{"minecraft:custom_name":{text:"Sulfuric Acid",color:"aqua",italic:false},"minecraft:lore":[{text:"H2SO4",color:"gray",italic:false},{text:"Lab compound",color:"dark_gray",italic:false}],"minecraft:custom_data":{lab_compound:"H2SO4",lab_is_compound:1b},"minecraft:max_stack_size":1,"minecraft:potion_contents":{custom_color:16777164,custom_effects:[{id:"minecraft:instant_damage",duration:1,amplifier:1}]}}}}
...
tellraw @a[distance=..8] {"text":"[Lab] 2 H + S + 4 O -> Sulfuric Acid (H2SO4)","color":"aqua"}
# experiments
