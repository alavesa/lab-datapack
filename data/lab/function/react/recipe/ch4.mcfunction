# C + 4 H -> Methane (CH4). Exact match only.
...
summon item ~0.5 ~1.1 ~0.5 {PickupDelay:15,Item:{id:"minecraft:potion",count:1,components:{"minecraft:custom_name":{text:"Methane",color:"aqua",italic:false},"minecraft:lore":[{text:"CH4",color:"gray",italic:false},{text:"Lab compound",color:"dark_gray",italic:false}],"minecraft:custom_data":{lab_compound:"CH4",lab_is_compound:1b},"minecraft:max_stack_size":1,"minecraft:potion_contents":{custom_color:12582847,custom_effects:[{id:"minecraft:nausea",duration:200,amplifier:0}]}}}}
...
tellraw @a[distance=..8] {"text":"[Lab] C + 4 H -> Methane (CH4)","color":"aqua"}
# experiments
