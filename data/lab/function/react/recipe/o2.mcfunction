# 2 O -> Oxygen Gas (O2). Exact match only.
...
summon item ~0.5 ~1.1 ~0.5 {PickupDelay:15,Item:{id:"minecraft:potion",count:1,components:{"minecraft:custom_name":{text:"Oxygen Gas",color:"aqua",italic:false},"minecraft:lore":[{text:"O2",color:"gray",italic:false},{text:"Lab compound",color:"dark_gray",italic:false}],"minecraft:custom_data":{lab_compound:"O2",lab_is_compound:1b},"minecraft:max_stack_size":1,"minecraft:potion_contents":{custom_color:10079487,custom_effects:[{id:"minecraft:water_breathing",duration:1200,amplifier:0}]}}}}
...
tellraw @a[distance=..8] {"text":"[Lab] 2 O -> Oxygen Gas (O2)","color":"aqua"}
# experiments
