# Na + O + H -> Lye (NaOH). Exact match only.
...
summon item ~0.5 ~1.1 ~0.5 {PickupDelay:15,Item:{id:"minecraft:potion",count:1,components:{"minecraft:custom_name":{text:"Lye",color:"aqua",italic:false},"minecraft:lore":[{text:"NaOH",color:"gray",italic:false},{text:"Lab compound",color:"dark_gray",italic:false}],"minecraft:custom_data":{lab_compound:"NaOH",lab_is_compound:1b},"minecraft:max_stack_size":1,"minecraft:potion_contents":{custom_color:15790335,custom_effects:[{id:"minecraft:instant_damage",duration:1,amplifier:0}]}}}}
...
tellraw @a[distance=..8] {"text":"[Lab] Na + O + H -> Lye (NaOH)","color":"aqua"}
# experiments
