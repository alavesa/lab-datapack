...
summon item ~0.5 ~1.1 ~0.5 {PickupDelay:15,Item:{id:"minecraft:potion",count:1,components:{"minecraft:custom_name":{text:"Sulfur Dioxide",color:"aqua",italic:false},"minecraft:lore":[{text:"SO2",color:"gray",italic:false},{text:"Lab compound",color:"dark_gray",italic:false}],"minecraft:custom_data":{lab_compound:"SO2",lab_is_compound:1b},"minecraft:max_stack_size":1,"minecraft:potion_contents":{custom_color:16777113,custom_effects:[{id:"minecraft:poison",duration:150,amplifier:0}]}}}}
...
tellraw @a[distance=..8] {"text":"[Lab] S + 2 O -> Sulfur Dioxide (SO2)","color":"aqua"}
# experiments
