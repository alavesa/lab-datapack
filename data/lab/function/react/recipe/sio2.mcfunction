# Si + 2 O -> Silica (SiO2). Exact match only.
...
summon item ~0.5 ~1.1 ~0.5 {PickupDelay:15,Item:{id:"minecraft:glass",count:2}}
...
title @a[distance=..8] actionbar {"text":"The mixture becomes Silica.","color":"gray"}
# experiments
