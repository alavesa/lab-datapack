...
#   6 SCP-294 (drink dispenser GUI - two Quarters per cup)
#   7 SCP-038 (the everything tree - a 1x2x1 barrier column, no spawner)
...
execute unless score #type lab.var matches 4 unless score #type lab.var matches 7 run setblock ~ ~ ~ minecraft:spawner
execute if score #type lab.var matches 7 run fill ~ ~ ~ ~ ~1 ~ minecraft:barrier
...
execute if score #type lab.var matches 6 run summon item_display ~ ~ ~ {Tags:["lab.display","lab.newdisp"],brightness:{sky:15,block:10},item:{id:"minecraft:dropper",count:1,components:{"minecraft:custom_model_data":{strings:["lab_scp294"]}}}}
execute if score #type lab.var matches 6 run summon interaction ~ ~-0.5 ~ {Tags:["lab.machine","lab.scp294"],width:1.05f,height:1.02f,response:1b}
execute if score #type lab.var matches 7 run summon item_display ~ ~ ~ {Tags:["lab.display","lab.newdisp"],brightness:{sky:15,block:10},item:{id:"minecraft:oak_sapling",count:1,components:{"minecraft:custom_model_data":{strings:["lab_scp038"]}}}}
execute if score #type lab.var matches 7 run summon interaction ~ ~-0.5 ~ {Tags:["lab.machine","lab.scp038"],width:1.05f,height:2.02f,response:1b}
...
execute if score #type lab.var matches 6 run title @s actionbar {"text":"SCP-294 installed.","color":"gray"}
execute if score #type lab.var matches 7 run title @s actionbar {"text":"SCP-038 planted.","color":"gray"}
