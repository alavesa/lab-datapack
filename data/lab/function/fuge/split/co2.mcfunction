# Centrifuge: Carbon Dioxide (CO2) -> C + 2 O. As the tube item entity.
...
summon item ~ ~0.4 ~ {PickupDelay:20,Item:{id:"minecraft:firework_star",count:1,components:{"minecraft:custom_name":{text:"Carbon",color:"aqua",italic:false},"minecraft:lore":[{text:"C - element 6",color:"gray",italic:false}],"minecraft:custom_data":{lab_element:"C",lab_is_element:1b},"minecraft:max_stack_size":1,"minecraft:custom_model_data":{strings:["lab_el_c"]},"minecraft:firework_explosion":{shape:"small_ball",colors:[I;5636095]}}}}
...
title @a[distance=..8] actionbar {"text":"Separated Carbon Dioxide into C + 2 O.","color":"gray"}
kill @s
