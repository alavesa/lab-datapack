...
$give @s minecraft:firework_star[custom_name={text:"$(name)",color:"$(color)",italic:false},lore=[{text:"$(sym) - element $(num)",color:"gray",italic:false}],custom_data={lab_element:"$(sym)",lab_is_element:1b$(extra)},max_stack_size=1,firework_explosion={shape:"small_ball",colors:[I;$(rgb)]}]
